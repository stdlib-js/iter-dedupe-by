...
```javascript
import iterDedupeBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-dedupe-by@v0.1.0-deno/mod.js';
```
...
[@stdlib/iter/dedupe]: https://github.com/stdlib-js/iter-dedupe/tree/deno
